...
describe('Service Tests', () => {
  describe('Profile Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Profile(0, 'AAAAAAA', 0, 'AAAAAAA', 0, 'AAAAAAA', Musictype.CHANT, 'AAAAAAA', false, 'AAAAAAA', 0);
    });
        ...
        const returnedFromService = Object.assign(
          {
            sexe: 'BBBBBB',
            age: 1,
            residentState: 'BBBBBB',
            phone: 1,
            artistName: 'BBBBBB',
            categorie: 'BBBBBB',
            otherMusicType: 'BBBBBB',
            eventParticipation: true,
            eventParticipationName: 'BBBBBB',
            experienceTime: 1
          },
          elemDefault
        );
